...
vi.mock('@modelcontextprotocol/sdk/client/index.js', () => ({
  // biome-ignore lint/complexity/useArrowFunction: must stay constructible (called with `new`)
...
describe('connectAndQuery', () => {
  ...
  it.each(['success', 'connect failure', 'list failure'])(
    'clears deadline timers after %s',
    async (outcome) => {
      mockClientInstance.connect.mockResolvedValue(undefined)
