...
export async function connectAndQuery(name: string, config: ServerConfig): Promise<ServerResult> {
  ...
  try {
    ...
    // Create MCP client
    client = new Client({ name: 'mcp-token-tracker', version: '1.0.0' }, { capabilities: {} })
